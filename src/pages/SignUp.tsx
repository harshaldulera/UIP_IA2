    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-800 shadow-lg rounded-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 rounded-lg bg-gray-700 text-white focus:outline-none"
            />
            <button className="absolute inset-y-0 right-4 flex items-center text-gray-400 hover:text-white">
              👁️
            </button>
          </div>
        ...
        <div className="space-y-3">
          ...
          <button className="w-full bg-gray-700 hover:bg-gray-600 text-white py-2 rounded-lg flex items-center justify-center space-x-2">
            <span>Continue with Harshal123</span>
            <span>👤</span>
          </button>
          <button className="w-full bg-white hover:bg-gray-200 text-black py-2 rounded-lg flex items-center justify-center space-x-2">
            <span>Continue with Google</span>
            <span>🌐</span>
          </button>
          <button className="w-full bg-gray-900 hover:bg-gray-800 text-white py-2 rounded-lg flex items-center justify-center space-x-2">
